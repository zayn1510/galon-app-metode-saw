...
import { CreateDepotRequest } from '@/types/depot';
...
const CreateDepotForm = () => {
  ...
  const [formData, setFormData] = useState<CreateDepotRequest>({
    nama_depot: '',
    alamat: '',
    kecamatan_id: 0,
    latitude: 0,
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl w-full space-y-8">
        ...
        <h2 className="mt-6 text-3xl font-extrabold text-gray-900">Daftarkan Depot Baru</h2>
        <p className="mt-2 text-sm text-gray-600">Isi detail berikut untuk mendaftarkan depot Anda</p>
